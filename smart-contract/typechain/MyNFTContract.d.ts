...
interface MyNFTContractInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "cost()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "incrementMaxSupply(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "maxHoldableItems()": FunctionFragment;
    ...
    "setSaleStatus(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "incrementMaxSupply",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maxHoldableItems",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class MyNFTContract extends BaseContract {
  ...
  interface: MyNFTContractInterface;
  ...
  functions: {
    ...
    incrementMaxSupply(
      _additionalSupply: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    maxHoldableItems(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    maxHoldableItems(overrides?: CallOverrides): Promise<PopulatedTransaction>;
